...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
                enlargelimits=0.15,
                legend style={at={(0.5,-0.15)}, align=center, font=\small,
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[smooth, mark=*, red] coordinates {(512,0.211) (1024,0.857) (2048,5.741) (4096,24.2) (8192,96.436)};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Speed Up da implementação OpenMP (24 threads)}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[smooth, mark=*, blue] coordinates {(2,8.823) (4,6.228) (8,7.765) (16,11.503) (24,NaN)};

            \legend{MPI (Controller/Worker)}
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[smooth, mark=*, blue] coordinates {(512,0.251) (1024,1.13) (2048,6.258) (4096,23.548) (8192,89.392)};
            \addplot[smooth, mark=*, brown] coordinates {(512,0.082) (1024,0.284) (2048,2.515) (4096,11.021) (8192,43.785)};
            \addplot[smooth, mark=*, red] coordinates {(512,0.211) (1024,0.857) (2048,5.741) (4096,24.2) (8192,96.436)};
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Comparação do tempo de execução das implemetações sequencial, OpenMP e MPI Controller/Worker}
    \label{fig:seq_mpi_cw_time_line_chart}
\end{figure}

É possível observar na Figura \ref{fig:seq_mpi_cw_time_line_chart} que a implementação MPI Controller/Worker quase que se equipara à implementação Sequencial Otimizada. Isso acontece pelo mesmo motivo citado anteriormente, o overhead de comunicação entre os Processos.
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot coordinates {(512,0.84) (1024,0.76) (2048,0.92) (4096,1.03) (8192,1.08)};

            \legend{MPI C/W\\(4 processos)}
        \end{axis}
    \end{tikzpicture}
    \caption{Speed Up da implementação MPI Controller/Worker}
    \label{fig:seq_mpi_cw_speedup_bar_chart}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[smooth, mark=*, blue] coordinates {(2,2.7) (4,1.995) (8,1.747) (16,1.681) (24,NaN)};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[smooth, mark=*, blue] coordinates {(512,0.045) (1024,0.137) (2048,1.681) (4096,9.14) (8192,36.588)};
            \addplot[smooth, mark=*, gray] coordinates {(512,0.251) (1024,1.13) (2048,6.258) (4096,23.548) (8192,89.392)};
            \addplot[smooth, mark=*, brown] coordinates {(512,0.082) (1024,0.284) (2048,2.515) (4096,11.021) (8192,43.785)};
            \addplot[smooth, mark=*, red] coordinates {(512,0.211) (1024,0.857) (2048,5.741) (4096,24.2) (8192,96.436)};

            \legend{
                MPI SPMD\\ (16 processos),
                MPI C/W\\ (4 processos),
                OpenMP\\(16 threads),
                Sequencial\\Otimizado
            }
    ...
    \end{tikzpicture}
    \caption{Comparação do tempo de execução das implemetações sequencial, OpenMP e MPI Controller/Worker}
    \label{fig:seq_mpi_spmd_time_line_chart}
\end{figure}

É possível observar na Figura \ref{fig:seq_mpi_spmd_time_line_chart} que
como a implementação MPI SPMD não possui um gargalo de desempenho causado pelo processo controlador, ela é considerávelmente mais rápida que a implementação MPI Controller/Worker. É importante destacar que foi utilizada a versão de 4 processos da implementação MPI Controller/Worker para a comparação, pois é a versão que apresenta o melhor desempenho entre as versões com diferentes quantidades de processos.
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot coordinates {(512,4.69) (1024,6.26) (2048,3.42) (4096,2.65) (8192,2.64)};

            \legend{MPI SPMD\\(16 processos)}
        \end{axis}
    \end{tikzpicture}
